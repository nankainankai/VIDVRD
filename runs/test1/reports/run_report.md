...
- 运行目录：`runs/test1`
- 开始时间：2026-05-26 16:48:44
- 结束时间：2026-05-26 16:48:50
- 配置文件：`configs/dry_run.json`
- 输入视频数量：1
- 成功：1，失败：0，跳过：0，部分完成：0
- 最终关系数：46
- 最终关系文件：`runs/test1/pred/relations_pred.json`
...
### test1_video
- state: succeeded
- outputs: `{'relations_pred_json': 'runs/test1/videos/test1_video/export/relations_pred.json', 'trajectories_pred_json': 'runs/test1/videos/test1_video/export/trajectories_pred.json'}`
